...
public interface Api {
    ...
    Flowable<ApiResponse<List<Movie>>> getPopularMovies(@Query("page") String page);

    @GET(ENDPOINT_SEARCH)
    Flowable<ApiResponse<List<Movie>>> getSearch(@Query("query") String query, @Query("page") String page);
}
